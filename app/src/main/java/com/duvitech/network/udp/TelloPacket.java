...
public class TelloPacket {
    ...
    private static final String TAG = "TelloPacket" ;
    ...
    short size13;
    byte crc8;
    boolean fromDrone; // the following 4 fields are encoded in a single byte in the raw packet
    boolean toDrone;
    byte packetType; // 3-bit
    byte packetSubtype; // 3-bit
    short messageID;
    short sequence;
    byte[] payload;
    short crc16;
    ...
    private short calculateCRC16(){
        short crc = (short)0x3692;

        return crc;
    }

    public TelloPacket(){
        mData = ByteBuffer.allocate(512);
    }
